...
\texttt{input\_val}   & Output             & \texttt{`INPUTOUTBIT} & Packed input value. \\ \hline
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/io_controller_flowchart.pdf}
...
\texttt{clk}         & Input              & 1              & Clock signal for synchronization. \\ \hline
\texttt{rst}         & Input              & 1              & Reset signal to initialize the module. \\ \hline
\texttt{result}      & Input              & \texttt{`INPUTOUTBIT} & BF16 result to be displayed. \\ \hline
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/display_controller_flowchart.pdf}
...
The \texttt{add} module is designed to perform signed integer addition of two 16-bit inputs and output the result in BFloat16 (BF16) format. The module ensures accurate computation and handles overflow conditions gracefully.
...
\begin{enumerate}
    ...
    \item \textbf{Overflow Handling:} If an overflow occurs, the \texttt{error} signal is asserted, and the result is set to the maximum or minimum representable value in BF16 format.
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/add_flowchart.pdf}
% \caption{Flowchart of the Addition Module}
% \label{fig:add_flowchart}
% \end{figure}

\noindent The module ensures efficient and accurate addition of signed integers, with robust handling of overflow conditions and conversion to BF16 format.
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/sub_flowchart.pdf}
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/cos_flowchart.pdf}
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/arccos_flowchart.pdf}
...
\texttt{start}       & Input              & 1              & Start signal to initiate the computation. \\ \hline
\texttt{a}           & Input              & 16             & Signed integer input representing the angle in degrees. \\ \hline
\texttt{result}      & Output             & 16             & The computed sine value in BFloat16 format. \\ \hline
\texttt{done}        & Output             & 1              & A signal indicating that the computation is complete. \\ \hline
\texttt{error}       & Output             & 1              & A flag indicating if an error occurred during computation. \\ \hline
\end{tabular}
\end{table}
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/sin_flowchart.pdf}
...
\subsubsection*{Block Diagram and Operation}
The \texttt{tan} module operates as follows:
\begin{enumerate}
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/tan_flowchart.pdf}
...
\subsubsection*{Block Diagram and Operation}
The \texttt{arctan} module operates as follows:
\begin{enumerate}
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/arctan_flowchart.pdf}
...
\subsubsection*{Block Diagram and Operation}
The \texttt{fac} module operates as follows:
\begin{enumerate}
...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=0.8\textwidth]{images/fac_flowchart.pdf}
% \caption{Flowchart of the Factorial Module}
% \label{fig:fac_flowchart}
% \end{figure}

\noindent The module ensures efficient computation of factorial values, with robust handling of invalid inputs and conversion to BF16 format.
